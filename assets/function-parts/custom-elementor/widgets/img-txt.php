...
class FBK_Elementor_ImageText extends \Elementor\Widget_Base
{
   ...
   protected function render()
   {
      ...
      if (!empty($settings['imgtxt_btn_link']['url'])) {
         $this->add_link_attributes('imgtxt_btn_link', $settings['imgtxt_btn_link']);
      }
      $btn_label2 = $settings['imgtxt_btn_label2'];
      if (!empty($settings['imgtxt_btn_link2']['url'])) {
         $this->add_link_attributes('imgtxt_btn_link2', $settings['imgtxt_btn_link2']);
      }
               ...
               <div class="col-12 col-lg-6">
                  <div class="content">
                     ...
                     if ($text) : ?>
                        ...
                        <?php endif;
                     if ($btn_label) : ?>
                           <a <?php echo $this->get_render_attribute_string('imgtxt_btn_link'); ?> class="button button-primary col-lg-auto col-12 ms-3 my-lg-0 my-3"><?php echo $btn_label; ?><span class="svg-wrapper">
                        ...
                        <?php endif;
                     if ($btn_label2) : ?>
                           <a <?php echo $this->get_render_attribute_string('imgtxt_btn_link'); ?> class="button button-primary col-lg-auto col-12 ms-3 my-lg-0 my-3"><?php echo $btn_label2; ?><span class="svg-wrapper">
                                 <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.7239 3.33333H2.66672V2H14V13.3333H12.6667V4.27614L3.13812 13.8047L2.19531 12.8619L11.7239 3.33333Z" fill="white" />
                                 </svg>
                              </span>
