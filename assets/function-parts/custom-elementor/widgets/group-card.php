...
class FBK_Elementor_GroupCard extends \Elementor\Widget_Base
{
   ...
   protected function render()
   {
      ...
      if (!empty($settings['group-card_btn_link']['url'])) {
         $this->add_link_attributes('group-card_btn_link', $settings['group-card_btn_link']);
      }
...
?>
      ...
      <section class="fbk-cw fbk-cw-pages fbk-cw-group-card container mb-section<?php if (is_singular('documenti') || is_singular('comunicazioni')) : echo " fbk-cw-single";
                                                                                 endif; ?>">
         ...
         <div class="row latest-loop">
            ...
            ?>
               ...
               <div class="col-card col-12 col-lg-6">
                  ...
                  <a class="card card-primary" <?php if ($card_link['url']) : ?> href="<?php echo esc_url($card_link['url']); ?>" <?php endif;
                                                                                                                              if ($card_link['is_external']) : ?> target="_blank" rel="noopener noreferrer" <?php endif; ?>>
                     ...
                     <div class="content">
                        <p class="meta">
                           <span class="label_date_cat"><?php if ($card_overtitle) : echo $card_overtitle;
                                                         endif; ?></span>
                        </p>
                        <?php if ($card_title) : ?><p class="h3-style"><?php echo $card_title; ?></p><?php endif; ?>
                        <div class="wysiwyg"><?php echo $card_text; ?></div>
                     </div>
                  </a>
