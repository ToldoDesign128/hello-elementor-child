...
function hello_elementor_child_enqueue_scripts()
{
   ...
   if (is_singular('documenti')) : wp_enqueue_script('howto-doc-script', get_stylesheet_directory_uri() . '/assets/js/single-doc.js', array('jquery'), false, true);
   endif;
   if (is_archive()) : wp_enqueue_script('howto-archive-script', get_stylesheet_directory_uri() . '/assets/js/scripts-archive.js', array('jquery'), false, true);
   endif;
}
...
function action_documenti_custom_columns($column)
{
   ...
   if ($column == 'documenti_tax') {
      ...
      if ($IDfield && is_array($IDfield)) :
         ...
         if ($Stickyfield) : echo "In evidenza";
         endif;
      endif;
   }
}
...
function NP_change_wp_search_size($query)
{ //search.php
   if ($query->is_search)
...
function NP_change_wp_archive_size($query)
{ //archive.php
