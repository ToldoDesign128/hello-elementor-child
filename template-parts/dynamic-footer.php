...
<footer>
    ...
    <!-- Informazioni -->
    <section class="container footer-info my-5 py-5">
        <div class="row align-items-center">
            <div class="col-12 col-md-5 row  align-items-center"> <!-- Logo -->
                <div class="col-2 p-0">
                ...
                <p class="col-10 p-0"> FBK | FONDAZIONE BRUNO KESSLER  © 2022 </p>
            </div>
            ...
            <div class="col-12 col-md-4 row align-items-center"> 
                <img src=" <?php echo get_stylesheet_directory_uri() . '/assets/image/icon/Darkmode.png';?>" alt="Light/night mode" class="col-1 p-0">
                <p class="col-2 p-0">ITA</p>
                <a href="" class="col-8 p-0"><button> <img src=" <?php echo get_stylesheet_directory_uri() . '/assets/image/icon/info.png';?>" alt="info"> LASCIA UN FEEDBACK </button></a>
            </div>
        </div>
    </section>
