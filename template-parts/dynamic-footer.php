      ...
      <div class="row">
         ...
         ?>
            <div class="col-12 col-sm-6 col-md-4 footer-menu-list">
               <a href="<?php echo $page_url ?>" class="footer-parent<?php if ($page_id == $current_id) : echo ' current-footer';
                                                                     endif; ?>"><?php echo $page_title ?></a>
               ...
               ?>
                     <a href="<?php echo $child_url ?>" class="footer-child <?php if ($child_id == $current_id || $page_ID_cur == $child_id) : echo ' current-footer';
                                                                              endif; ?>"><?php echo $child_title; ?></a>
               <?php endforeach;
               endif; ?>
            </div>
         <?php endforeach; ?>
